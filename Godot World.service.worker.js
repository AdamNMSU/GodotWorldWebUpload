...
/** @type {string} */
const CACHE_VERSION = '1789782326|448785597';
/** @type {string} */
const CACHE_PREFIX = 'Godot World-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Godot World.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Godot World.html","Godot World.js","Godot World.offline.html","Godot World.icon.png","Godot World.apple-touch-icon.png","Godot World.audio.worklet.js","Godot World.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Godot World.wasm","Godot World.pck"];
